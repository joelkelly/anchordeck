...
class AuthController extends BaseController {
    ...
    public function postLogin()
    {
        ...
        if ($validator->passes())
        {
            try
            {
                ...
                return Redirect::to('site/account/login')->with('error', 'That password is incorrect.');
            }
            ...
            // Redirect to the login page
            return Redirect::to('account/login')->with('error', $error);
        }

        // Something went wrong with inpur validation
    ...
    public function postRegister()
    {
        ...
        if ($validator->passes())
        {
            ...
            // Redirect to the register thanks page
            return View::make('site/account/register-thanks')->with('user', $user->first_name);
        }
